  ...
  return (
    <div>
      <div className="titulo">
        <h2>{titulo}</h2>
        <h2>{subTitulo}</h2>
        <h2 className='Posicion'>Antecedentes para Puntaje</h2>
      </div>
      ...
      <form className='form__formulario' onSubmit={handleSubmit(onSubmit)}>
        <section className="datos-personales">
          ...
          <h3 className="encabezados">Títulos académicos</h3>{/* ENCABEZADOS*/}
          <hr />
        ...
        <section className="domicilio_y_datos_de_contacto">
          <h3 className="encabezados">Trayectorias laborales</h3>
          <hr />
...
{resideProvincia === 'NO' && (
        ...
        <section className="educacion_formal">
          ...
          <h3 className="encabezados">Capacitaciones realizadas o dictadas</h3>
          <hr />
